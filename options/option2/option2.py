...
print('\n' + '-' * 20 + '\n' + 'Нажата кнопка "Многоканальные СМО с отказами"' + '\n' + '-' * 20 + '\n')
time.sleep(1)

# Вывод того, что мы перешли на страницу "СМО с неограниченными очередями"
print('\n' + '-' * 20 + '\n' + 'Переход на страницу "СМО с отказами"' + '\n' + '-' * 20 + '\n')
time.sleep(2)
...
with open('options/option2/data.json', 'r') as f:
    data = json.load(f)
...
# Находим кнопку "Сохранить решение в TXT"
txt_button = driver.find_element(by='id', value = 'saveTxtButton')

# Находим кнопку "Сохранить решение в Excel"
excel_button = driver.find_element(by='id', value = 'saveExcelButton')
...
excel_button.click()
print('\n' + '-' * 20 + '\n' + 'Нажата кнопка "Сохранить решение в Excel"' + '\n' + '-' * 20 + '\n')
time.sleep(2)
